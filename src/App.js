...
const SECAccountPlanning = () => {
  ...
  const IFSLogo = () => (
    <div className="flex items-center space-x-3">
      ...
      <span className="text-2xl font-bold text-gray-900 dark:text-white dark:text-white">IFS</span>
    </div>
  );
            ...
            <div className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8 text-center shadow-sm hover:shadow-md transition-shadow">
                  <Users className="mx-auto mb-4 text-purple-700 dark:text-purple-400 dark:text-purple-400" size={40} />
                  <div className="text-4xl font-bold text-gray-900 dark:text-white dark:text-white mb-2">11.2M</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 font-medium">Customers Served</div>
                </div>
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8 text-center shadow-sm hover:shadow-md transition-shadow">
                  <Zap className="mx-auto mb-4 text-purple-700 dark:text-purple-400 dark:text-purple-400" size={40} />
                  <div className="text-4xl font-bold text-gray-900 dark:text-white dark:text-white mb-2">70.7 GW</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 font-medium">Peak Load 2023</div>
                </div>
                <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8 text-center shadow-sm hover:shadow-md transition-shadow">
                  <DollarSign className="mx-auto mb-4 text-purple-700 dark:text-purple-400 dark:text-purple-400" size={40} />
                  <div className="text-4xl font-bold text-gray-900 dark:text-white dark:text-white mb-2">$133B</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300 dark:text-gray-300 font-medium">Total Assets</div>
                </div>
              </div>
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30 rounded-xl p-8 border border-purple-200 dark:border-purple-700">
                <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white dark:text-white">Vision 2030 Alignment</h3>
                <p className="text-gray-700 dark:text-gray-200 dark:text-gray-200 leading-relaxed text-lg">
          ...
          content: (
            <div className="space-y-6">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8 shadow-sm">
                <h3 className="text-2xl font-bold mb-6 flex items-center text-gray-900 dark:text-white dark:text-white">
                  <Globe className="mr-3 text-purple-700 dark:text-purple-400 dark:text-purple-400" size={28} /> Market Size & Growth
                </h3>
                <ul className="space-y-4">
                  <li className="flex items-start">
                    <ChevronRight className="mr-3 mt-1 flex-shrink-0 text-purple-700 dark:text-purple-400 dark:text-purple-400" size={20} />
                    <span className="text-gray-700 dark:text-gray-200 dark:text-gray-200 text-lg">$81.7B market value (2024) with steady growth trajectory</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="mr-3 mt-1 flex-shrink-0 text-purple-700 dark:text-purple-400 dark:text-purple-400" size={20} />
                    <span className="text-gray-700 dark:text-gray-200 dark:text-gray-200 text-lg">5% annual demand growth driven by Vision 2030 initiatives</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="mr-3 mt-1 flex-shrink-0 text-purple-700 dark:text-purple-400 dark:text-purple-400" size={20} />
                    <span className="text-gray-700 dark:text-gray-200 dark:text-gray-200 text-lg">Record peak load of 70,663 MW in 2023 (8.2% YoY increase)</span>
                  </li>
                  <li className="flex items-start">
                    <ChevronRight className="mr-3 mt-1 flex-shrink-0 text-purple-700 dark:text-purple-400" size={20} />
                    <span className="text-gray-700 dark:text-gray-200 text-lg">MENA electricity demand projected to rise 50% by 2035</span>
                  </li>
                </ul>
              </div>
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8 shadow-sm">
                <h3 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Regulatory Framework</h3>
            ...
            <div className="space-y-4">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <ChevronRight size={24} className="text-purple-700 dark:text-purple-400" />
                  <span className="text-sm font-semibold text-green-600 bg-green-50 px-4 py-2 rounded-lg">TO: 50% renewable &amp; 50% gas by 2030</span>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-300">KPI: Renewables 0% → 50%, Liquid fuel eliminated by 2030, Net-zero by 2050</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">KPI: 30-50% reduction in unplanned outages, &gt;90% equipment effectiveness</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">KPI: 30-40% faster process cycles, single source of truth, digital maturity 4.5/5</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">KPI: Customer satisfaction 81% → &gt;90%, First-contact resolution &gt;85%</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300">KPI: EBITDA margin ~30%, Gov subsidy &lt;2%, Investment-grade credit maintained</p>
              </div>
            </div>
          )
        }
      ...
      slides: [
          ...
          content: (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3"><strong>Focus:</strong> Vision 2030 delivery, financial sustainability, reliability</p>
                <p className="text-sm text-gray-600 dark:text-gray-300"><strong>Pain Points:</strong> Balancing SAR 500B capex with debt management, avoiding major outages, driving transformation</p>
              </div>

              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <h4 className="font-bold mb-3 text-green-700 text-lg">CFO / SVP Finance</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3"><strong>Focus:</strong> Capital efficiency, cost control, credit rating maintenance</p>
                <p className="text-sm text-gray-600 dark:text-gray-300"><strong>Pain Points:</strong> Managing SAR 45B annual capex, optimizing O&amp;M, RAB model compliance</p>
              </div>

              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <h4 className="font-bold mb-3 text-purple-700 dark:text-purple-400 text-lg">COO / EVP Operations</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3"><strong>Focus:</strong> Reliability, operational efficiency, safety excellence</p>
                <p className="text-sm text-gray-600 dark:text-gray-300"><strong>Pain Points:</strong> Coordination across divisions, minimizing SAIDI/SAIFI, workforce optimization</p>
              </div>

              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <h4 className="font-bold mb-3 text-yellow-700 text-lg">CIO / Chief Digital Officer</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3"><strong>Focus:</strong> Digital transformation, system modernization, cybersecurity</p>
                <p className="text-sm text-gray-600 dark:text-gray-300"><strong>Pain Points:</strong> Heterogeneous systems, data silos, managing SAP/Oracle upgrades</p>
              </div>
            </div>
          )
        },
        {
          ...
          content: (
            <div className="space-y-4">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                <h4 className="font-bold mb-3 flex items-center text-gray-900 dark:text-white text-lg">
                  <Zap className="mr-3 text-yellow-500" size={24} />
                  EVP Generation
                </h4>
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Challenge:</strong> Maximize plant reliability, minimize forced outages, optimize fuel efficiency</p>
                <p className="text-sm text-gray-600 dark:text-gray-300"><strong>IFS Value:</strong> Predictive maintenance to prevent unplanned downtime, integrated project management for overhauls</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Challenge:</strong> Resilient grid expansion, managing 84,000 km of lines, renewable integration</p>
                <p className="text-sm text-gray-600 dark:text-gray-300"><strong>IFS Value:</strong> Linear asset management, GIS integration, predictive analytics for grid assets</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Challenge:</strong> Faster outage restoration, customer satisfaction &gt;90%, efficient new connections</p>
                <p className="text-sm text-gray-600 dark:text-gray-300"><strong>IFS Value:</strong> FSM optimization, mobile workforce, proactive customer communications</p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Challenge:</strong> Shift from reactive to predictive maintenance, spare parts optimization</p>
                <p className="text-sm text-gray-600 dark:text-gray-300"><strong>IFS Value:</strong> Comprehensive EAM, IoT/AI integration, condition-based maintenance strategies</p>
              </div>
            </div>
          )
        }
          ...
          content: (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-5 shadow-sm">
                <h4 className="font-bold mb-2 text-gray-900 dark:text-white">🔮 Predictive Maintenance for Power Plants</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3">IoT sensors + ML to predict equipment failures before unplanned outages</p>
              ...
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl p-5 shadow-sm">
                <h4 className="font-bold mb-2 text-gray-900 dark:text-white">⚡ Outage Management &amp; Fast Restoration</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3">Streamlined end-to-end outage process with optimized crew dispatch</p>
              ...
              <div className="bg-gradient-to-br from-pink-50 to-pink-100 border border-pink-200 rounded-xl p-5 shadow-sm">
                <h4 className="font-bold mb-2 text-gray-900 dark:text-white">💰 Asset Investment Planning</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3">Value-driven portfolio optimization for SAR 500B capex program</p>
              ...
              <div className="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-xl p-5 shadow-sm">
                <h4 className="font-bold mb-2 text-gray-900 dark:text-white">📱 Mobile Workforce Empowerment</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3">Advanced mobile tools + AR support for first-time fix improvement</p>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-xl p-5 shadow-sm">
                <h4 className="font-bold mb-2 text-gray-900 dark:text-white">📦 Inventory Optimization</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3">Analytics-driven spare parts planning for billions in inventory</p>
              ...
              <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 border border-yellow-200 rounded-xl p-5 shadow-sm">
                <h4 className="font-bold mb-2 text-gray-900 dark:text-white">🗺️ Linear Asset Management &amp; GIS</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3">Spatial integration for 84,000 km transmission network</p>
              ...
              <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl p-5 shadow-sm">
                <h4 className="font-bold mb-2 text-gray-900 dark:text-white">🎯 Enterprise Project Management</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3">Robust PM practices for on-time, on-budget capital projects</p>
              ...
              <div className="bg-gradient-to-br from-teal-50 to-teal-100 border border-teal-200 rounded-xl p-5 shadow-sm">
                <h4 className="font-bold mb-2 text-gray-900 dark:text-white">😊 Customer Experience Enhancement</h4>
                <p className="text-sm text-gray-700 dark:text-gray-200 mb-3">Omnichannel communication, proactive outage alerts</p>
          ...
          content: (
            <div className="space-y-4">
              <div className="bg-white border-l-4 border-blue-500 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-200">One platform covering asset, workforce, supply chain, projects, service. SAP/Oracle require multiple products + heavy integration.</p>
              </div>
              ...
              <div className="bg-white border-l-4 border-green-500 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-200">AI-powered optimization consistently delivers 10-20% productivity improvements vs. competitors' basic scheduling.</p>
              </div>
              ...
              <div className="bg-white border-l-4 border-purple-500 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-200">Built for utilities with linear asset management, GIS integration, crew shift planning out-of-the-box. No heavy customization needed.</p>
              </div>
              ...
              <div className="bg-white border-l-4 border-yellow-500 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-200">IDC study: $5.5M annual savings, 11-month payback. Includes 50% faster outage resolution, 30% lower IT complexity.</p>
              </div>
              ...
              <div className="bg-white border-l-4 border-red-500 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-200">Intuitive, web-based interface with fully offline-capable mobile apps. SAP/Oracle UIs are clunky and complex by comparison.</p>
              </div>
              ...
              <div className="bg-white border-l-4 border-pink-500 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-700 dark:text-gray-200">Strategic partnership with Saudi Business Machines (SBM) ensures strong local presence + IFS's global R&amp;D backing.</p>
              </div>
            </div>
          )
        }
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-3 gap-6">
                <div className="bg-gradient-to-br from-green-50 to-green-100 border-2 border-green-300 rounded-xl p-8 text-center shadow-sm">
                  ...
                  <div className="text-base text-gray-900 dark:text-white font-semibold mb-2">Annual O&amp;M Savings</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">10-15% reduction through optimized maintenance &amp; scheduling</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 border-2 border-blue-300 rounded-xl p-8 text-center shadow-sm">
                  ...
                  <div className="text-base text-gray-900 dark:text-white font-semibold mb-2">Annual Capex Optimization</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">5% efficiency improvement on SAR 40B annual capex</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 border-2 border-purple-300 rounded-xl p-8 text-center shadow-sm">
                  <div className="text-5xl font-bold text-purple-700 dark:text-purple-400 mb-3">SAR 750M</div>
                  <div className="text-base text-gray-900 dark:text-white font-semibold mb-2">Working Capital Release</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">15% inventory reduction one-time cash benefit</div>
                </div>
              </div>

              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8 shadow-sm">
                <h3 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">5-Year ROI Summary</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <div className="text-gray-600 dark:text-gray-300 mb-2 font-medium">Total Investment</div>
                    <div className="text-3xl font-bold text-red-600 mb-1">SAR 300-400M</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Software, implementation, training</div>
                  </div>
                  <div>
                    <div className="text-gray-600 dark:text-gray-300 mb-2 font-medium">Total Benefits (5 years)</div>
                    <div className="text-3xl font-bold text-green-600 mb-1">SAR 10B+</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">O&amp;M + Capex + Inventory + Productivity</div>
                  </div>
                  <div>
                    <div className="text-gray-600 dark:text-gray-300 mb-2 font-medium">Payback Period</div>
                    <div className="text-3xl font-bold text-yellow-600 mb-1">&lt;2 Years</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Early benefits self-fund later phases</div>
                  </div>
                  <div>
                    <div className="text-gray-600 dark:text-gray-300 mb-2 font-medium">5-Year ROI</div>
                    <div className="text-3xl font-bold text-blue-600 mb-1">4:1+</div>
                    <div className="text-sm text-gray-500 dark:text-gray-400">Consistent with IDC 414% ROI finding</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        },
        {
          ...
          content: (
            <div className="space-y-4">
              <div className="bg-white border-l-4 border-blue-500 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="font-bold text-gray-900 dark:text-white text-lg">Phase 1: Foundation &amp; Quick Wins</h4>
              ...
              <div className="bg-white border-l-4 border-cyan-500 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="font-bold text-gray-900 dark:text-white text-lg">Phase 2: Core EAM &amp; FSM Rollout</h4>
              ...
              <div className="bg-white border-l-4 border-teal-500 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="font-bold text-gray-900 dark:text-white text-lg">Phase 3: Advanced Capabilities</h4>
              ...
              <div className="bg-white border-l-4 border-green-500 rounded-xl p-6 shadow-sm">
                <div className="flex items-center justify-between mb-3">
                  <h4 className="font-bold text-gray-900 dark:text-white text-lg">Phase 4: Stabilization &amp; Optimization</h4>
          ...
          content: (
            <div className="space-y-4">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Challenge:</strong> High unplanned outage rates, reactive maintenance</p>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Challenge:</strong> Multi-utility coordination, emergency response efficiency</p>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <h4 className="font-bold mb-3 text-purple-700 dark:text-purple-400 text-lg">📊 IDC Independent Study</h4>
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Methodology:</strong> Analysis of IFS Cloud customers across industries</p>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Challenge:</strong> Excess inventory tying up capital</p>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-700 dark:text-gray-200 mb-2"><strong>Challenge:</strong> Safety incident rates, HSE compliance</p>
        ...
        },
        {
          ...
          content: (
            <div className="space-y-5">
              <div className="bg-white border-l-4 border-green-500 rounded-xl p-6 shadow-sm">
                <h4 className="font-bold mb-3 flex items-center text-gray-900 dark:text-white text-xl">
      ...
      slides: [
        {
          ...
          content: (
            <div className="space-y-6">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-8 shadow-sm">
                <h3 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Immediate Actions</h3>
                <div className="space-y-5">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-lg mb-1">Executive Briefing</h4>
                      <p className="text-gray-700 dark:text-gray-200">Schedule presentation with CIO/CDO and operational EVPs showcasing IFS capabilities + SEC-specific value proposition</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-lg mb-1">Workshop Series</h4>
                      <p className="text-gray-700 dark:text-gray-200">Conduct focused workshops with key departments: Generation maintenance, Distribution ops, Asset planning, Customer service</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-lg mb-1">Reference Visits</h4>
                      <p className="text-gray-700 dark:text-gray-200">Arrange site visits to similar utilities using IFS (Dubai, Europe, or regional) to see system in action</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-lg mb-1">Pilot Proposal</h4>
                      <p className="text-gray-700 dark:text-gray-200">Develop detailed proposal for Phase 1 pilot (6 months) in selected region/facility to demonstrate quick wins</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-xl p-6 shadow-sm">
                <h3 className="text-xl font-bold mb-4 text-gray-900 dark:text-white">Key Contacts</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <p className="text-gray-600 dark:text-gray-300 text-sm font-medium">Account Executive</p>
                    <p className="font-bold text-gray-900 dark:text-white text-lg">Mark Marawy</p>
                  </div>
                  <div>
                    <p className="text-gray-600 dark:text-gray-300 text-sm font-medium">Local Partner</p>
                    <p className="font-bold text-gray-900 dark:text-white text-lg">Saudi Business Machines (SBM)</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          content: (
            <div className="space-y-6">
              <div className="bg-gradient-to-br from-purple-50 via-blue-50 to-purple-50 border-2 border-purple-300 rounded-2xl p-10 shadow-lg">
                <h3 className="text-3xl font-bold mb-6 text-center text-gray-900 dark:text-white">Empowering the Kingdom's Future, Today</h3>
                <p className="text-gray-700 dark:text-gray-200 text-center mb-8 text-lg leading-relaxed">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div className="bg-white rounded-xl p-6 shadow-sm">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">Digital transformation imperative, sustainability mandates, customer service excellence</p>
                  </div>
                  <div className="bg-white rounded-xl p-6 shadow-sm">
                    <h4 className="font-bold mb-3 text-blue-700 text-lg">✓ Market Timing</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">RAB model stable, renewables ramping up, smart meter foundation in place</p>
                  </div>
                  <div className="bg-white rounded-xl p-6 shadow-sm">
                    <h4 className="font-bold mb-3 text-purple-700 dark:text-purple-400 text-lg">✓ Proven Technology</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">IFS battle-tested with major utilities, 414% ROI validated by IDC, 97%+ renewal rate</p>
                  </div>
                  <div className="bg-white rounded-xl p-6 shadow-sm">
                    <h4 className="font-bold mb-3 text-yellow-700 text-lg">✓ Local Partnership</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-300">SBM alliance ensures on-ground support, Arabic language, cultural alignment</p>
                  </div>
                </div>
              ...
              <div className="text-center bg-white border-2 border-purple-500 rounded-xl p-8 shadow-lg">
                <p className="text-3xl font-bold text-purple-700 dark:text-purple-400 mb-3">Let's Begin This Journey Together</p>
                <p className="text-gray-700 dark:text-gray-200 text-lg">IFS stands ready as your committed partner in SEC's transformation</p>
              </div>
            </div>
          )
        }
